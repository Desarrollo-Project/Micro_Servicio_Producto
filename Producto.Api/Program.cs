...
using Producto.Infrastructure.EventBus.Consumer; // Aseg�rate que este namespace sea donde est� ProductoCreadoEventConsumerService
...
// Registrar autenticaci�n y autorizaci�n
...
// Registrar MongoInitializer como Singleton (la ejecuci�n se har� despu�s de app.Build())
builder.Services.AddSingleton<MongoInitializer>();

// Obtener configuraci�n de RabbitMQ
var rabbitHost = builder.Configuration["RabbitMQ:Host"]
    ?? throw new InvalidOperationException("Falta la configuraci�n RabbitMQ:Host");
var rabbitUser = builder.Configuration["RabbitMQ:Username"]
    ?? throw new InvalidOperationException("Falta la configuraci�n RabbitMQ:Username");
var rabbitPass = builder.Configuration["RabbitMQ:Password"]
    ?? throw new InvalidOperationException("Falta la configuraci�n RabbitMQ:Password");
...
// Middleware pipeline
// Considera volver a poner la condici�n si solo quieres Swagger en Desarrollo
...
// Inicializaci�n de MongoDB (Lugar correcto para ejecutarla)
